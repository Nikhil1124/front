  ...
  return (
    <>
      ...
      <Row gap={10} style={{ flexWrap: 'wrap' }}>
        <TouchableOpacity activeOpacity={0.8} onPress={() => onGoToChecks?.('Electrical')} style={{ flex: 1, minWidth: 100 }}>
        ...
        <TouchableOpacity activeOpacity={0.8} onPress={() => onGoToChecks?.('Cleanliness')} style={{ flex: 1, minWidth: 100 }}>
          <Card containerColor={Colors.surface} borderRadius={Radii.lg} borderWidth={1} borderColor={Colors.borderSubtle} padding={[12, 8]} style={{ flex: 1, alignItems: 'center', shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 5, elevation: 2 }}>
        ...
        <TouchableOpacity activeOpacity={0.8} onPress={() => onGoToChecks?.('Kitchen Hygiene')} style={{ flex: 1, minWidth: 100 }}>
          <Card containerColor={Colors.surface} borderRadius={Radii.lg} borderWidth={1} borderColor={Colors.borderSubtle} padding={[12, 8]} style={{ flex: 1, alignItems: 'center', shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 5, elevation: 2 }}>
      ...
      <Row gap={10} style={{ flexWrap: 'wrap' }}>
        <TouchableOpacity activeOpacity={0.8} onPress={() => onGoToChecks?.('Plumbing')} style={{ flex: 1, minWidth: 100 }}>
          <Card containerColor={Colors.surface} borderRadius={Radii.lg} borderWidth={1} borderColor={Colors.borderSubtle} padding={[12, 8]} style={{ flex: 1, alignItems: 'center', shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 5, elevation: 2 }}>
        ...
        <TouchableOpacity activeOpacity={0.8} onPress={() => onGoToChecks?.('General')} style={{ flex: 1, minWidth: 100 }}>
          <Card containerColor={Colors.surface} borderRadius={Radii.lg} borderWidth={1} borderColor={Colors.borderSubtle} padding={[12, 8]} style={{ flex: 1, alignItems: 'center', shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 5, elevation: 2 }}>
