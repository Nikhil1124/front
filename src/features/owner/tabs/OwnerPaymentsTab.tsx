  ...
  return (
    <View style={{ flex: 1, padding: 16 }}>
      ...
      {subTab !== 2 ? (
        ...
        // Verified collections ledger can run to ~100 payments (refreshAll fetches up to
        // 100) — FlatList instead of `.map()` in a ScrollView so only the visible rows mount.
        <FlatList
          style={{ flex: 1 }}
          data={verifiedList}
