          ...
          <Card containerColor={Colors.surface} borderRadius={Radii.card} borderWidth={1} borderColor={Colors.borderSubtle} padding={[16, 16]}>
            ...
            {activeDelivery.status !== 'Completed' && (
              <>
                ...
                <Spacer size={16} />
                <Btn onPress={confirmDelivery} disabled={!photoUri || confirming} loading={confirming} containerColor={photoUri ? Colors.success : Colors.surfaceMuted} textColor={photoUri ? '#FFF' : Colors.textMuted} borderRadius={Radii.control} height={50}>
    ...
    <View style={styles.root}>
      <FormScroll {...dockScroll} contentContainerStyle={{ padding: 18, paddingBottom: 100, gap: 16 }}>
        ...
        {activeTrip && activeTrip.status === 'planned' && (
          <>
            <Spacer size={12} />
            <Btn onPress={handleDepart} containerColor={Colors.primary} textColor="#FFFFFF" borderRadius={Radii.control} height={48} loading={departTripMut.isPending}>
              ...
              <Card containerColor={Colors.primaryDark} borderRadius={Radii.card} padding={[20, 16]} style={{ shadowColor: Colors.primaryDark, shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.15, shadowRadius: 12, elevation: 6, overflow: 'hidden' }}>
                ...
                <Row align="center" justify="space-between">
                  <Row gap={12} align="center">
                    <View style={{ backgroundColor: '#FFFFFF', borderRadius: Radii.control, paddingVertical: 12, paddingHorizontal: 14, alignItems: 'center', justifyContent: 'center' }}>
                ...
                <Spacer size={24} />
                <Row gap={12}>
                  <Btn onPress={() => setActiveDeliveryId(current.id)} containerColor="#FFFFFF" textColor={Colors.primaryDark} borderRadius={Radii.control} height={48} style={{ flex: 1 }}>
                  ...
                  <Btn onPress={() => openInMaps(current.location || current.pgName)} containerColor={Colors.primary} textColor="#FFFFFF" borderRadius={Radii.control} height={48} style={{ flex: 1, borderWidth: 1, borderColor: Colors.borderSubtle }}>
            ...
            return (
              <Row key={r.id} style={{ minHeight: 70 }}>
                ...
                <Col align="center" style={{ width: 40, position: 'relative' }}>
                  ...
                  <View style={{ width: 26, height: 26, borderRadius: Radii.pill, backgroundColor: isCompleted ? Colors.success : (isCurrent ? Colors.primaryDark : '#FFFFFF'), borderWidth: isPending ? 2 : 0, borderColor: Colors.warning, alignItems: 'center', justifyContent: 'center', zIndex: 2, marginTop: 26 }}>
